...
'''
Fetched from MTTS:A Demo of MTTS Mandarin/Chinese Text to Speech FrontEnd
...
def seprate_syllable(syllable):
    ...
    elif re.match(pun,syllable):
        syllable = syllable[:-1]
        if len(syllable)==1:
            return syllable
        else:
            return syllable[0],syllable[1]
    elif re.match(letters,syllable):
        return syllable[:-1]
    else:
